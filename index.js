...
/////////////////
const BotName = ' *GHALYH BOT* '; 
const instagram = 'https://instagram.com/ghlyhalamn'; 
const telegram = '-'; 
const kapanbotaktif = '24 jam'; 
const youtube = '-';
//const grupch1 = 'https://chat.whatsapp.com/G3yYhho2lz4D3UiruLHp1M'; 
//const grupch2 = 'https://chat.whatsapp.com/G3yYhho2lz4D3UiruLHp1M' ; 
const
{
   WAConnection,
   MessageType,
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by BYS')
